...
def test_ac():
    ...
    model_path = 'C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/models/AC_MODEL.h5'
    ...
    if predicted_mask is not None:
        ...
        #plot_image_path = 'static/plot_images/AC_plot.png'
...
def test_bpd():
    ...
    model_path = 'C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/models/BDP_MODEL.h5'
    ...
    if 'file' in request.files:
        ...
        if uploaded_file.filename != '':
            ...
            if test_image is not None:
                ...
                loaded_model = keras.models.load_model('C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/models/vle6_updated.h5')
    ...
    if 'file' in request.files:
        ...
        if uploaded_file.filename != '':
            ...
            if test_image is not None:
                ...
                # Load the pre-trained model
                loaded_model = keras.models.load_model('C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/models/VLS10.h5')
    ...
    if 'file' in request.files:
        ...
        if uploaded_file.filename != '':
            ...
            if test_image is not None:
                ...
                # Load the pre-trained model
                loaded_model = keras.models.load_model('C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/models/vls8.h5')
    ...
    if 'file' in request.files:
        ...
        if uploaded_file.filename != '':
            ...
            if test_image is not None:
                ...
                # Load the pre-trained model
                loaded_model = keras.models.load_model('C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/models/Aloka_model.h5')
...
@app.route('/get_image')
def get_image():
    # Get the filename from the request or any other source
    image_filename = request.args.get('filename')  # Example: 'AC_plot.png'

    # Path to the folder containing the images
    folder_path = 'C:/Users/SCOM/Desktop/Fetal-Health-Anaysis-FYP--Revised-2-jasonify-API-/static/plot_images/'
